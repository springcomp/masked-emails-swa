...
describe('HashService.hashPassword', () => {
  ...
  it('should convert arrays to base64', () => {
    const hashService: HashService = TestBed.get(HashService);
    const b = hashService.toBase64(
      new Uint8Array([195, 169, 108, 195, 169, 109, 101, 110, 116])
    );
  ...
  it('should return pseudo random salt array', () => {
    const hashService: HashService = TestBed.get(HashService);
    const s = hashService.randomSalt(4);
  ...
  it('should hash plain text password', () => {
    ...
    expect(hashed).toBe(
      'JClY1QtvRV/YfYhb05OaW1jj4J2sNo6lG6DxkAX5MBt88N8ZJcSkfqf5LAjm5x9ign24ThyyGNPWK54/8nIaXjZVTDA='
    );
  });
});
